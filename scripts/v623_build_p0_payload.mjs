...
const out = [
  ...
  `export const P0_SCRIPT = ${JSON.stringify(script)};`,
  `export const P0_SCRIPT_SHA256 = ${JSON.stringify(scriptSha)};`,
  `export const W16_NOTEBOOK_SHA256 = ${JSON.stringify(notebookSha)};`,
  `export const W16_SOURCE_ZIP_SHA256 = ${JSON.stringify(sourceZipSha)};`,
  `export const P0_GITHUB_RUN_ID = ${JSON.stringify(githubRunId)};`,
  `export const P0_EXPIRES_AT_MS = ${expiresAtMs};`,
  '',
].join('\n');
