...
def test_builder_read_retry():
    ...
    assert "import datetime, http.client, json, os, pathlib, re, time, urllib.error, urllib.request" in text
    assert "except (urllib.error.URLError, TimeoutError, OSError, http.client.HTTPException) as exc:" in text
